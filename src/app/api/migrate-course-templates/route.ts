  ...
  try {
    ...
    if (!tables || tables.length === 0) {
      return NextResponse.json(
        {
          error:
            "Course templates table does not exist. Please run the SQL migration first.",
          instructions:
            "Create the course_templates table in your Supabase SQL editor",
        },
        { status: 400 }
      );
    }
    ...
    const { data: template, error: templateError } = await supabase
      ...
      .insert({
        ...
        description:
          "Template for CBSE Mathematics courses with comprehensive structure",
        curriculum: "CBSE",
        subject: "Mathematics",
        grade: "Class 10",
        structure: {
                  ...
                  units: [
                    {
                      title: "Real Numbers",
                      description:
                        "Fundamental Theorem of Arithmetic, proofs of irrationality for √2, √3, √5",
                    },
                  ],
                },
                {
                  ...
                  units: [
                    {
                      ...
                      description:
                        "Distance Formula and Section (Internal Division) Formula",
                    },
                  ],
                },
                {
                  ...
                  units: [
                    {
                      title: "Triangles",
                      description:
                        "Triangles (similarity), Circles (tangent properties)",
                    },
                  ],
                },
                {
