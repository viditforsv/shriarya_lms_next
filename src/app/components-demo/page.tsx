  ...
  return (
    <section className="mb-20">
      <div className="mb-8 pb-6 border-b border-slate-200">
        <h2 className="text-3xl font-bold text-[#1b4a56] mb-4 font-dm-sans">Pagination Components</h2>
        <p className="text-slate-600 text-lg">Pagination controls and navigation</p>
      </div>
...
const ComponentsDemoPage = memo(function ComponentsDemoPage() {
  ...
  const renderColorsSection = () => (
    <section className="mb-20">
      <div className="mb-8 pb-6 border-b border-slate-200">
        <h2 className="text-3xl font-bold text-[#1b4a56] mb-4 font-dm-sans">Color Palette</h2>
  ...
  const renderButtonsSection = () => (
    <section className="mb-20">
      <div className="mb-8 pb-6 border-b border-slate-200">
        ...
        <p className="text-slate-600 text-lg">Core button variants and sizes for the LMS</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow duration-200">
          <CardHeader className="bg-slate-50/50">
            <CardTitle className="text-xl text-slate-800">Button Variants</CardTitle>
            <CardDescription className="text-slate-600">All available button styles</CardDescription>
          </CardHeader>
        ...
        <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow duration-200">
          <CardHeader className="bg-slate-50/50">
            <CardTitle className="text-xl text-slate-800">Button Sizes</CardTitle>
            <CardDescription className="text-slate-600">Available size options</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 p-6">
  ...
  const renderFormsSection = () => (
    <section className="mb-20">
      <div className="mb-8 pb-6 border-b border-slate-200">
        <h2 className="text-3xl font-bold text-[#1b4a56] mb-4 font-dm-sans">Form Components</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow duration-200">
          <CardHeader className="bg-slate-50/50">
            <CardTitle className="text-xl text-slate-800">Basic Inputs</CardTitle>
            <CardDescription className="text-slate-600">Standard form fields</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 p-6">
        ...
        <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow duration-200">
          <CardHeader className="bg-slate-50/50">
            <CardTitle className="text-xl text-slate-800">Validation States</CardTitle>
            <CardDescription className="text-slate-600">Input states and validation</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 p-6">
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-red-700">Error Input</label>
              <input 
                type="text" 
  ...
  const renderCardsSection = () => (
    <section className="mb-20">
      <div className="mb-8 pb-6 border-b border-slate-200">
        <h2 className="text-3xl font-bold text-[#1b4a56] mb-4 font-dm-sans">Card Components</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow duration-200">
          <CardHeader className="bg-slate-50/50">
            ...
            <CardDescription className="text-slate-600">Standard card with header and content</CardDescription>
          </CardHeader>
          <CardContent className="p-6">
            <p className="text-slate-600">This is a basic card component with header, content, and description.</p>
          </CardContent>
        </Card>

        <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow duration-200">
          <CardHeader className="bg-slate-50/50">
            <CardTitle className="text-xl text-slate-800">Card with Footer</CardTitle>
            <CardDescription className="text-slate-600">Card including footer section</CardDescription>
          </CardHeader>
          <CardContent className="p-6">
  ...
  const renderBadgesSection = () => (
    <section className="mb-20">
      <div className="mb-8 pb-6 border-b border-slate-200">
        <h2 className="text-3xl font-bold text-[#1b4a56] mb-4 font-dm-sans">Badge Components</h2>
  ...
  const renderBreadcrumbsSection = () => (
    <section className="mb-20">
      <div className="mb-8 pb-6 border-b border-slate-200">
        <h2 className="text-3xl font-bold text-[#1b4a56] mb-4 font-dm-sans">Breadcrumb Components</h2>
      ...
      <div className="space-y-6">
        <div className="bg-slate-50/50 rounded-lg p-4 border border-slate-200">
            ...
            { label: "Algebra", href: "/courses/mathematics/algebra", isActive: true }
              ]} />
            </div>
  ...
  const renderLayoutSection = () => (
    <section className="mb-20">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-[#1b4a56] mb-4 font-dm-sans">Layout Components</h2>
  ...
  const renderTypographySection = () => (
    <section className="mb-20">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-[#1b4a56] mb-4 font-dm-sans">Typography</h2>
  ...
  const renderInteractiveSection = () => (
    <section className="mb-20">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-[#1b4a56] mb-4 font-dm-sans">Interactive Components</h2>
        <p className="text-gray-600 text-lg">Interactive elements and controls</p>
      </div>
        ...
        <CardHeader>
          ...
          <CardContent className="space-y-4">
            <div className="w-full bg-gray-200 rounded-sm h-2">
              <div className="bg-[#1b4a56] h-2 rounded-sm" style={{width: '60%'}}></div>
              </div>
  ...
  const renderNavigationSection = () => (
    <section className="mb-20">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-[#1b4a56] mb-4 font-dm-sans">Navigation Components</h2>
  ...
  const renderUtilitiesSection = () => (
    <section className="mb-20">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-[#1b4a56] mb-4 font-dm-sans">Utility Components</h2>
          ...
          <div className="max-w-7xl mx-auto px-8 py-12">
            ...
            <div className="mb-12 text-center">
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                Comprehensive collection of reusable UI components for the ShriArya LMS platform
              </p>
        </div>
