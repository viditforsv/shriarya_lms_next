...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#fffefd] to-[#feefea]">
      {/* Hero Section */}
      <section className="relative py-20 bg-gradient-to-br from-[#feefea] to-[#fffefd] border-b border-[#feefea]">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-5xl font-bold text-[#1e293b] mb-6">
              Get in Touch
            </h1>
            <p className="text-xl text-[#1e293b]/80 mb-8 max-w-3xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              <Badge
                variant="outline"
                className="border-[#e27447] text-[#e27447] px-4 py-2"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <Card className="p-6 hover:shadow-lg transition-shadow border-[#feefea]">
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-[#feefea] rounded-sm flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[#e27447] font-medium">
                        contact@shrividhya.in
                      </p>
                ...
                <Card className="p-6 hover:shadow-lg transition-shadow border-[#feefea]">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[#1e293b]/80">2919P, Ground Floor</p>
            ...
            {/* Contact Form */}
            <div>
              <Card className="p-8 shadow-lg border-[#feefea]">
                <CardHeader>
                  <CardTitle className="text-2xl text-[#1e293b]">
                    Send us a Message
                  </CardTitle>
                  <CardDescription className="text-[#1e293b]/70">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 border border-[#feefea] rounded-sm focus:outline-none focus:ring-2 focus:ring-[#e27447] focus:border-[#e27447] transition-all bg-white"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        rows={5}
                        className="w-full px-4 py-3 border border-[#feefea] rounded-sm focus:outline-none focus:ring-2 focus:ring-[#e27447] focus:border-[#e27447] transition-all resize-none bg-white"
                    ...
                    <Button
                      type="submit"
                      className="w-full bg-[#e27447] hover:bg-[#e27447]/90 text-white py-3 rounded-sm"
                    >
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            <Card className="p-6 hover:shadow-lg transition-shadow border-[#feefea]">
              <CardHeader>
                <CardTitle className="text-lg text-[#1e293b] flex items-center">
                  <MessageSquare className="w-5 h-5 text-[#e27447] mr-2" />
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow border-[#feefea]">
              <CardHeader>
                <CardTitle className="text-lg text-[#1e293b] flex items-center">
                  <Clock className="w-5 h-5 text-[#e27447] mr-2" />
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow border-[#feefea]">
              <CardHeader>
                <CardTitle className="text-lg text-[#1e293b] flex items-center">
                  <Globe className="w-5 h-5 text-[#e27447] mr-2" />
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow border-[#feefea]">
              <CardHeader>
                <CardTitle className="text-lg text-[#1e293b] flex items-center">
                  <MessageCircle className="w-5 h-5 text-[#e27447] mr-2" />
        ...
        <section className="text-center">
          <Card className="p-12 bg-gradient-to-br from-[#feefea] to-[#fffefd] border-[#e27447]">
            <CardHeader>
              ...
              <CardDescription className="text-lg text-[#1e293b]/70">
            ...
            <CardContent>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  ...
                  Book Consultation over WhatsApp
                </Button>
              </div>
            </CardContent>
          </Card>
