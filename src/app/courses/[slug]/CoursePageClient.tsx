...
export function CoursePageClient({ courseParams }: { courseParams: { slug: string } }) {
  // const { user } = useAuth()
  const user = null
                            ...
                            >
                              ...
                              <div className="flex-1">
                                <div className="flex items-center space-x-2">
                                  <h4 className="font-medium text-lg">{unit.title}</h4>
                                </div>
                                    ...
                                    >
                                      ...
                                      <div className="flex-1">
                                        ...
                                        <p className="text-xs text-gray-500">
                                          {chapter.subsections?.length || 0} topics
                                        </p>
                                      </div>
