...
export async function generateMetadata({
  ...
  try {
    ...
    const title = course.title || "Shrividhya Classes Course";
    const description =
      course.description?.substring(0, 160) || "Learn with Shrividhya Classes";
    ...
    return {
      title: "Shrividhya Classes Course",
      description: "Learn with Shrividhya Classes",
    };
  }
}
