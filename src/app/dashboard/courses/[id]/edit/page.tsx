    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          <p className="text-red-600 mb-4">Please log in to access the course builder</p>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input
                      id="slug"
                      value={course?.slug || ''}
                      onChange={(e) => setCourse(prev => prev ? { ...prev, slug: e.target.value } : null)}
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-4">
                      <Badge className={course?.is_free ? 'bg-green-500' : 'bg-[#e27447]'}>
                    ...
                    <div className="space-y-2">
                      ...
                      {lessons.map((lesson, index) => (
                        <div key={lesson.id} className="flex items-center space-x-2 p-2 bg-gray-50 rounded-sm">
            ...
            <Card className="border-[#feefea]">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="text-sm text-muted-foreground">
                  ...
                  <p>• {lessons.filter(l => l.is_preview).length} preview lessons</p>
                  <p>• Last saved: {course?.updated_at ? new Date(course.updated_at).toLocaleDateString() : 'Never'}</p>
                </div>
