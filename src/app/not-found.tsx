            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <Button asChild variant="outline" size="sm">
                  <Link href="/courses/discover">Browse Courses</Link>
                </Button>
              </CardContent>
            </Card>
          ...
          <Card className="bg-[#feefea] border-[#e27447]">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-[#1e293b] mb-6 max-w-2xl mx-auto">
                If you&apos;re still having trouble finding what you&apos;re
                looking for, our support team is here to help you navigate the
                platform.
              </p>
