...
import { ArrowLeft, FileText, Scale, Users, Calendar, AlertTriangle } from "@/app/components-demo/ui/icons"
import { memo } from 'react'
import Link from "next/link"

const TermsPageTemplate = memo(function TermsPageTemplate() {
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-[#1e293b] mb-4">Terms of Service Template</h1>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            A comprehensive terms of service template covering user agreements, rights, and responsibilities.
          </p>
        </div>
