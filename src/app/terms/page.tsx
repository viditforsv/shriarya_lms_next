        ...
        <section className="py-20 bg-gradient-to-br from-secondary to-muted mb-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Please read these terms carefully before using our learning
              management platform.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="mb-8 border-[#feefea]">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  By accessing and using ShriArya LMS (&quot;the Service&quot;),
                  you accept and agree to be bound by the terms and provision of
                  this agreement.
                </p>
                <p>
                  If you do not agree to abide by the above, please do not use
                  this service. These Terms of Service govern your use of our
            ...
            <Card className="mb-8 border-[#feefea]">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  ShriArya LMS provides an online learning management platform
                  that enables:
                </p>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <div>
                  ...
                  <p className="text-sm">
                    ...
                    functionality are owned by ShriArya LMS and are protected by
                ...
                <div>
                  ...
                  <p className="text-sm">
                    ...
                    license to use, modify, and distribute it for educational
                    purposes within our platform.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="mb-8 border-[#feefea]">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  In no event shall ShriArya LMS, nor its directors, employees,
          ...
          <Card className="max-w-2xl mx-auto border-[#e27447] bg-gradient-to-br from-[#feefea] to-[#fffefd]">
            <CardContent className="py-8">
              ...
              <p className="text-muted-foreground mb-6">
                Our legal team is here to help. Contact us for any questions
                about these terms.
              </p>
              <div className="flex gap-4 justify-center">
                <a href="mailto:contact@shrividhya.in?subject=Terms of Service Inquiry">
