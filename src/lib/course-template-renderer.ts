...
import { CourseTemplate, CourseData, RenderedCourse, TemplateStructure } from '@/types/course-templates'
...
export function renderCourseWithTemplate(
  ...
  const rendered: RenderedCourse = {
    ...
    curriculum: courseData.curriculum || templateData.curriculum || defaultValues.curriculum,
    subject: courseData.subject || templateData.subject || defaultValues.subject,
    grade: courseData.grade || templateData.grade || defaultValues.grade,
    level: courseData.level || templateData.level || defaultValues.level,
 ...
 */
export function renderTemplateSections(template: CourseTemplate): TemplateStructure['sections'] {
